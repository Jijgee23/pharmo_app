...
import 'package:pharmo_app/views/main/pharmacy/promotion/buying_promo_dialog.dart';
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                text('-с дээш бол '),
                text(maybeNull(promo.procent.toString()), color: myColor, size: 20),
                text(' хямдрал '),
                noGift ? text('эдэлж') : text('эдлээрэй!')
              ],
            ),
            if (noGift) const Icon(Icons.add, color: AppColors.secondary, size: 30),
            if (noGift)
              Column(
                children: [
                  (noGift)
