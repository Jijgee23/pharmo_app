...
class MarkedPromoWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer2<BasketProvider, PromotionProvider>(
      builder: (_, basket, promotionProvider, child) => Scaffold(
        // appBar: AppBar(
        //   toolbarHeight: 20,
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    (promo.isMarked == true)
                        ? InkWell(
                            onTap: () =>
                                promotionProvider.hidePromo(promo.id!, context).then((e) => Navigator.pop(context)),
                ...
                Text(promo.name!,
                    style:
                        const TextStyle(fontSize: 16, color: AppColors.main)),
                SizedBox(
                  width: double.infinity,
                  height: 60,
