...
//             name: ChannelName.methods.value, binaryMessenger: registrar.messenger())
//         registrar.addMethodCallDelegate(instance, channel: channel)
//         channel.setMethodCallHandler(instance.handle)
//         BackgroundTaskPlugin.channel = channel

//         let bgEventChannel = FlutterEventChannel(
//             name: ChannelName.bgEvent.value, binaryMessenger: registrar.messenger())
...
//             name: ChannelName.statusEvent.value, binaryMessenger: registrar.messenger())
...
//             let pausesLocationUpdatesAutomatically =
//                 (args?["pausesLocationUpdatesAutomatically"] as? Bool) ?? false
//             let desiredAccuracy: DesiredAccuracy
//             if let value = args?["iOSDesiredAccuracy"] as? String,
//                 let type = DesiredAccuracy(rawValue: value)
//             {
...
//             locationManager.allowsBackgroundLocationUpdates = true
//             locationManager.showsBackgroundLocationIndicator = true
//             let (distanceFilter, desiredAccuracy, pausesLocationUpdatesAutomatically) =
...
//         StatusEventStreamHandler.eventSink?(
//             StatusEventStreamHandler.StatusType.updated(message: "lat:\(lat ?? 0) lng:\(lng ?? 0)")
//                 .value
//         )

//         let callbackHandlerRawHandle = UserDefaultsRepository.instance
//             .fetchCallbackHandlerRawHandle()
//         let data =
//             [
